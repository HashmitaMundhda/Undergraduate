...
public class driver {
    ...
    public static void main(String[] args) throws InterruptedException {
        configureLogging("game_final_result.log", "INFO");
        logger.info("*********************************Welcome to Snakes & Ladders by Hashmita Mundhda******************************");
        int noOfPlayer = 4;
        logger.info(noOfPlayer+" players are playing " );

        List<Player> players = new ArrayList();
        Player player1 = new Player(("Hashmita"));
        players.add(player1);
        Player player2 = new Player(("Dharmesh"));
        players.add(player2);
        Player player3 = new Player(("Yashita"));
        players.add(player3);
        Player player4 = new Player(("Chetna"));
        players.add(player4);
